...
in this summary, Class, Objects, Attributes, Methods, Constructors, inheritance are all implemented in one go.
...
and implement the rest of the principles in your own way. ✨
